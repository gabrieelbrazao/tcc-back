...
export default class Ficha extends BaseSchema {
  ...
  public async up() {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.integer('sono_id').unsigned().index().references('id').inTable('sono').notNullable()
      table.string('usa_remedios_para_dormir', 1).notNullable()
      table
        .integer('sensibilidade_a_dor_id')
        .unsigned()
        .index()
        .references('id')
      ...
      table
        .integer('frequencia_atividades_fisicas_id')
        .unsigned()
        .index()
        .references('id')
      ...
      table
        .integer('exposicao_solar_id')
        .unsigned()
        .index()
        .references('id')
        .inTable('exposicao_solar')
        .notNullable()
      ...
      table
        ...
        .inTable('fototipo')
        .notNullable()
      table.integer('etnia_id').unsigned().index().references('id').inTable('etnia').notNullable()
      table
        .integer('tipo_pele_id')
        .unsigned()
        .index()
        .references('id')
        .inTable('tipo_pele')
        .notNullable()
      table
        .integer('pele_ao_tato_id')
        .unsigned()
        .index()
        .references('id')
        .inTable('pele_ao_tato')
        .notNullable()
      table
        .integer('pele_sensibilidade_id')
        .unsigned()
        .index()
        .references('id')
      ...
      table.integer('acne_grau_id').unsigned().index().references('id').inTable('acne_grau')
